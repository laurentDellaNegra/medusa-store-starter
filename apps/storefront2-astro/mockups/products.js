...
const PRODUCTS = [
  {
    ...
    price: 189,
    badge: 'New Arrival',
    description: 'Our signature market tote, generously sized for everyday elegance. Hand-woven from sustainably harvested raphia palm fibres, this bag transitions effortlessly from morning market to afternoon soirée.',
    details: ['Hand-woven raphia palm fibre', 'Interior cotton lining', 'Leather-trimmed handles', 'Dimensions: 42 × 30 × 15 cm', 'Weight: 320g'],
  ...
  },
  {
    ...
    price: 145,
    badge: '',
    description: 'Refined simplicity in the palm of your hand. This structured clutch features an artisan-woven body with a polished brass clasp, perfect for evenings that demand understated sophistication.',
    details: ['Tightly woven raphia body', 'Brass magnetic clasp', 'Suede interior lining', 'Dimensions: 28 × 16 × 5 cm', 'Weight: 180g'],
  ...
  },
  {
    ...
    price: 215,
    badge: 'Bestseller',
    description: 'The perfect travel companion. La Voyageuse features a gracefully curved silhouette with an adjustable leather strap, designed for the woman who moves through life with effortless grace.',
    details: ['Hand-woven raphia with leather trim', 'Adjustable leather crossbody strap', 'Interior zip pocket', 'Dimensions: 24 × 20 × 10 cm', 'Weight: 260g'],
  ...
  },
  {
    ...
    description: 'Oversized luxury for sun-soaked days. La Plage is our most generously proportioned bag, featuring an open-weave design that lets the sea breeze flow through while keeping your essentials close.',
    details: ['Open-weave raphia construction', 'Reinforced leather base', 'Cotton canvas interior', 'Dimensions: 52 × 35 × 20 cm', 'Weight: 420g'],
  ...
  },
  {
    ...
    price: 125,
    badge: '',
    description: 'Small in stature, grand in character. La Petite is our most intimate creation — a miniature masterpiece that holds just the essentials: your keys, lipstick, and a touch of Malagasy magic.',
    details: ['Micro-woven raphia', 'Gold-tone chain strap', 'Snap closure', 'Dimensions: 18 × 14 × 6 cm', 'Weight: 120g'],
  ...
  },
  {
    ...
    price: 198,
    badge: 'New Arrival',
    description: 'Free-spirited elegance, drawn from the earth. La Bohème features a relaxed bucket silhouette with a drawstring closure, embodying the carefree sophistication of island life.',
    details: ['Structured raphia bucket shape', 'Leather drawstring closure', 'Detachable shoulder strap', 'Dimensions: 22 × 26 × 14 cm', 'Weight: 290g'],
